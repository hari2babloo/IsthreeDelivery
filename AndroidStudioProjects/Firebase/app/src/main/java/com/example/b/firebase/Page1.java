...
public class Page1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(Page1.this,2);
      ...
      //  String uid = (String) auth.getCurrentUser().getUid();
        ...
        myref= FirebaseDatabase.getInstance().getReference().child("Database3");
...
//        Log.e("Data",query.toString());
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(Page1.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
