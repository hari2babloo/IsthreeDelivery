...
public class Dresh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       RecyclerView.LayoutManager layoutManager = new GridLayoutManager(Dresh.this,2);
...
query=        myref.orderByChild("id").equalTo("WD");
...
//        Log.e("Data",query.toString());
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(Dresh.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {

                Person s = recyclerAdapter.getItem(position);

                Intent i = new Intent(getApplicationContext(), SubCatList.class);

                i.putExtra("key",s.getName());
                startActivity(i);
